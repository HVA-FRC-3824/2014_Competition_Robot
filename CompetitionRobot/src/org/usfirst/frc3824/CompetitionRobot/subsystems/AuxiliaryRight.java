...
public class AuxiliaryRight extends Subsystem 
{
    ...
    Solenoid rightShootSolenoid = RobotMap.auxiliaryRightRightShootSolenoid;
    Relay rightVacuum = RobotMap.auxiliaryRightRightVacuum;
    SpeedController rightShooterAdjust = RobotMap.auxiliaryRightRightShooterAdjust;
    ...
    {
        return rightShooterAdjust;
    }
    
    public void setShootSolenoids(boolean on)
    {
        rightShootSolenoid.set(on);
    }
}
