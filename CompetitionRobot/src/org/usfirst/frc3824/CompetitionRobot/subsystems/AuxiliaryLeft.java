...
public class AuxiliaryLeft extends Subsystem {
    ...
    Solenoid leftShootSolenoid = RobotMap.auxiliaryLeftLeftShootSolenoid;
    Relay leftVacuum = RobotMap.auxiliaryLeftLeftVacuum;
    SpeedController leftShooterAdjust = RobotMap.auxiliaryLeftLeftShooterAdjust;
    ...
    {
        return leftShooterAdjust;
    }
    
    public void setShootSolenoid(boolean on)
    {
        leftShootSolenoid.set(on);
    }    
}
