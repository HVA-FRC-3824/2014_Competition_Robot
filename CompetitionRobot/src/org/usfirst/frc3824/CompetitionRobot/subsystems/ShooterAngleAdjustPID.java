...
public class ShooterAngleAdjustPID extends PIDSubsystem
{
    ...
    private double convertAngleToVolts(double inputAngle)
    {
        ...
        volts = ((inputAngle - Constants.SHOOTER_ANGLE_MIN_VALUE) / 
                 (Constants.SHOOTER_ANGLE_MAX_VALUE - Constants.SHOOTER_ANGLE_MIN_VALUE)) * 5.0;
        return volts;
    }
    /**
    ...
    {
        double angle;
        angle = (inputVolts * (Constants.SHOOTER_ANGLE_MAX_VALUE - Constants.SHOOTER_ANGLE_MIN_VALUE)) / 
                 5.0 + Constants.SHOOTER_ANGLE_MIN_VALUE;
        return angle;
    }
}
