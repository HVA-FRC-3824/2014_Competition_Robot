...
public class RobotMap
{
    ...
    public static Solenoid auxiliaryLeftVerticalAdjust;
	...
	LiveWindow.addActuator("Auxiliary Left", "Vacuum", auxiliaryLeftVacuum);
	...
	LiveWindow.addSensor("Auxiliary Left", "Shooter Angle", auxiliaryLeftShooterAngle);
        ...
        auxiliaryLeftShooterAnglePID = new PIDController(0.1, 0.0, 0.0, 0.0, auxiliaryLeftShooterAngle, auxiliaryLeftShooterMotor, 0.02);
	LiveWindow.addActuator("Auxiliary Left", "ShooterAnglePID", auxiliaryLeftShooterAnglePID);
        auxiliaryLeftShooterAnglePID.setContinuous(false); auxiliaryLeftShooterAnglePID.setAbsoluteTolerance(0.2); 
        auxiliaryLeftShooterAnglePID.setInputRange(0.0, 5.0);
