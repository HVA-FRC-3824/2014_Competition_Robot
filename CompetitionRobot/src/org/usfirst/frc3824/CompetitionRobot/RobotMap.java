...
public class RobotMap
{
    ...
    public static SpeedController pickupWheelPickupTalon;
    ...
    public static Solenoid ballGuideBallGuideSolenoid;
	...
	LiveWindow.addActuator("Shooter", "Shoot Solenoid 4", shooterShootSolenoid4);
        ...
        pickupWheelPickupTalon = new Talon(1, 9);
	LiveWindow.addActuator("Pickup", "Wheel Pickup Talon", (Talon) pickupWheelPickupTalon);
	...
	LiveWindow.addActuator("Vacuum", "Vacuum", (Talon) vacuumVacuum);
        ...
        ballGuideBallGuideSolenoid = new Solenoid(1, 8);
	LiveWindow.addActuator("Ball Guide", "Ball Guide Solenoid", ballGuideBallGuideSolenoid);
