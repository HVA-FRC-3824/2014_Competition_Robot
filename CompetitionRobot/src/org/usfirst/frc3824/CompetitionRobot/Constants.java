...
public class Constants
{
    ...
    /* Constants copied from last years robot *//****** Shooter angle conversion (ADC to angle) ******/
    ...
    /****** PICKUP VOLTAGE ******/
    public final static double PICKUP_UP_VOLTAGE = -0.5;
    public final static double PICKUP_DOWN_VOLTAGE = 0.4;
