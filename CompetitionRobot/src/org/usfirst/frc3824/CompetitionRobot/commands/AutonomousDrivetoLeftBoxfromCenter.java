 ...
 *
 */
public class AutonomousDrivetoLeftBoxfromCenter extends CommandGroup {
    
    public  AutonomousDrivetoLeftBoxfromCenter() {
        // Add Commands here:
        ...
        addSequential(new ChassisDriveStraight(1.6, 0.5, 0));
