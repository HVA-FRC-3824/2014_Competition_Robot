...
public class ChassisDriveStraight extends Command
{
    ...
    private ChassisTurnAngle chassisTurnAngle;
    ...
    public ChassisDriveStraight(double duration, double power, double direction, ChassisTurnAngle chassisTurnAngle)
    {
        // Use requires() here to declare subsystem dependencies
        // eg. requires(chassis);
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
        ...
        drivePower = power;
        driveDirection = direction;
        this.chassisTurnAngle = chassisTurnAngle;
        setpointSpecified = true;
    }
