...
public class AutonomousTwoBallCenter extends CommandGroup
{
    public AutonomousTwoBallCenter()
    {
        ...
        addParallel(new SetShooterAngle(Constants.SHOOTER_AUTONOMOUS_TWO_BALL_FIRST_CENTER_POSITION));
        ...
        // get ready to shoot
        addSequential(new SetShooterAngle(Constants.SHOOTER_AUTONOMOUS_TWO_BALL_SECOND_CENTER_POSITION));
        addSequential(new PickupBallStop());
