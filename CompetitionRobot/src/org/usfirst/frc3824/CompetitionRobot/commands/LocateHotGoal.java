...
//        SmartDashboard.putData("TestImages", testImageChooser); 
    ...
    /**
     * Provide information about the last object seen possible cases are: - HOT
     * TARGET seen on LEFT (also updates distance and time) - HOT TARGET seen on
     * RIGHT (also updates distance and time) - NO HOT TARGET, but a TARGET WAS
     * SEEN (update distance and time) - NO OBJECTS SEEN at all (distance and
