 ...
 *
 */
public class CannonShootTwoPistons extends Command
{
    private static Timer timer = new Timer();

    public CannonShootTwoPistons()
    {
    ...
    protected void initialize()
    {
        ...
        Robot.shooter.setShooterSolenoidsTwoPistons(true);
        timer.reset();
        timer.start();         
    }
    ...
    protected void end()
    {
        ...
        Robot.shooter.setShooterSolenoidsTwoPistons(false);        
    }
