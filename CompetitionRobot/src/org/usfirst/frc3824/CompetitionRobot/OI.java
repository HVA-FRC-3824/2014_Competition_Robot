...
public class OI
{
    ...
    public OI()
    {
        ...
        SmartDashboard.putData("Auxiliary Left Vertical Toggle", new AuxiliaryLeftVerticalToggle());
        SmartDashboard.putData("Auxiliary Left Angle", new AuxiliaryLeftAngle());
