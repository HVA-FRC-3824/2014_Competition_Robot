...
public class OI
{
    ...
    public OI()
    {
        ...
        SmartDashboard.putData("Auxilary Left Vertical Toggle", new AuxilaryLeftVerticalToggle());
        SmartDashboard.putData("Auxilary Right Vertical Toggle", new AuxilaryRightVerticalToggle());
        SmartDashboard.putData("Auxilary Left Vacuum On", new AuxilaryLeftVacuumOn());
        SmartDashboard.putData("Auxilary Left Vacuum Off", new AuxilaryLeftVacuumOff());
        SmartDashboard.putData("Auxilary Left Vacuum Toggle", new AuxilaryLeftVacuumToggle());
        SmartDashboard.putData("Auxilary Right Vacuum On", new AuxilaryRightVacuumOn());
        SmartDashboard.putData("Auxilary Right Vacuum Off", new AuxilaryRightVacuumOff());
        SmartDashboard.putData("Auxilary Right Vacuum Toggle", new AuxilaryRightVacuumToggle());
	...
	m_shooterAngleTestLow.whenPressed(new SetShooterAngle(6.1));
	...
	m_shooterAngleShoot.whenPressed(new SetShooterAngle(25.0));
