...
public class OI
{
    ...
    public OI()
    {
        ...
        joystickToggleVacuum = new JoystickButton(driveJoystick, 11);
        joystickToggleVacuum.whenReleased(new VacuumControl());
        ...
        joystickShoot.whileHeld(new CannonShoot());
        ...
        SmartDashboard.putData("VacuumControl", new VacuumControl());
