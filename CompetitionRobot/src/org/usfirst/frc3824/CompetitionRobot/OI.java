...
public class OI
{
    ...
    public JoystickButton joystickShootOnePiston;
    ...
    public OI()
    {
        ...
        joystickShootThreePistons = new JoystickButton(driveJoystick, 1);
        joystickShootThreePistons.whileHeld(new CannonShootThreePistons());
        joystickShootTwoPistons = new JoystickButton(driveJoystick, 1);
        joystickShootTwoPistons.whileHeld(new CannonShootTwoPistons());
        joystickShootOnePiston = new JoystickButton(driveJoystick, 1);
        joystickShootOnePiston.whileHeld(new CannonShootOnePiston());
        ...
        SmartDashboard.putData("Cannon Shoot One Piston", new CannonShootOnePiston());
        SmartDashboard.putData("Cannon Shoot Two Pistons", new CannonShootTwoPistons());
